...
const getStatusBox = (status) => {
  switch (status) {
    case "Lead":
      return (
        <div className="h-full text-sm flex items-center justify-start capitalize bg-blue-400 bg-opacity-20 px-2 py-1 rounded-full">
    ...
    case "Active":
      return (
        <div className="h-full text-sm flex items-center justify-start capitalize bg-green-400 bg-opacity-20 px-3 py-1 rounded-full ">
    ...
    case "Archived":
      return (
        <div className="h-full text-sm flex items-center justify-start capitalize bg-gray-400 bg-opacity-20 px-2 py-1 rounded-full text-yellow-700">
            ...
            <tr>
              ...
              <td className="py-6">
                <div className="max-w-[220px]">
                  3 Hampshire Close Northwest Calgary, Alberta T3A 4X9
                </div>
              </td>
              <td className="py-6">
        ...
        <div className="w-full flex items-start justify-start gap-2">
          ...
          <div className="dark:text-dark-text">
            <p className="font-semibold">
              Client hasn't requested any work yets
            </p>
            <p>
              Clients can submit new requests for work online. You and your team
              can also create requests to keep track of new work that comes up.
            </p>
            <div className="my-1">
      ...
      <CustomTabPanel value={value} index={3}>
        <div className="w-full flex items-start justify-start gap-2 dark:text-dark-text">
          ...
          <div className="">
            ...
            <p>
              Let's get out there and work. Begin by creating this client's
              first job.
            </p>
            <div className="my-1">
                    ...
                    >
                      <td className="py-4 px-2">
                        <Link
                          href={property?.map ?? "#"}
                          target="_blank"
                          className="w-10 h-10 rounded border-green-700 border grid place-content-center hover:bg-green-700 hover:bg-opacity-20 cursor-pointer"
                ...
                <CustomMenu
                  ...
                  icon={
                    <CustomButton
                      onClick={() => null}
                      title={"New"}
                      frontIcon={<ChevronDown className="w-4 h-4" />}
                    />
                  }
                >
                ...
                <tr>
                    ...
                    <div className="flex">
                      ...
                      <div>
                        <p className="font-semibold text-sm">
                          Reminder about quote #5 for Md. Ashraful Islam
                        </p>
                  ...
                  <td className="max-w-[30%] w-[30%] dark:text-dark-text">
                    <div className="w-2/3 text-sm">
                      Quote was sent on 19/09/2024 but no job has been generated
                      yet
                    </div>
                  </td>
              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="max-w-[20%] w-[20%] py-4"></td>
                    <td></td>
                  </tr>
                </tbody>
              </table>
            ...
            <table className="w-full dark:text-dark-text">
              <tbody>
                {client?.mobile?.map((mobile, index) => (
                  <tr>
                    <td className="py-2 text-sm w-[200px] capitalize">
                      {mobile?.type}
                    </td>
                  ...
                  <div className="flex mt-2 mr-2 flex-wrap space-y-1 space-x-1">
                    {[1, 2, 3].map((tag, index) => {
                      return (
                        <div
                          key={index}
                          className="relative flex items-center justify-center overflow-hidden  bg-primary rounded-full group"
                        >
          ...
          <div className="border bg-gray-100 border-gray-300 p-4 rounded-lg dark:bg-dark-secondary">
            ...
            <div className="mt-4">
              <textarea
                ...
                id=""
                rows={3}
                className="w-full dark:text-dark-text dark:bg-dark-primary focus:outline-none border px-3 py-2 border-gray-300 focus:border-gray-400 rounded-lg"
              ></textarea>
            </div>
            ...
            <div className="mt-4 border-2 border-gray-300 text-sm border-dashed p-2 py-4 rounded-xl flex justify-center items-center">
              <label htmlFor="" className="text-gray-500">
                ...
                <span className="ml-2 text-green-700 font-semibold border-2 rounded-xl p-2">
                  Select a file
                </span>
              </label>
