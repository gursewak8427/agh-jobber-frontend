    ...
    return (
        <CustomModal show={Boolean(open)} onClose={onClose}>
            <div className="space-y-6 ">
                ...
                <p className='text-sm text-gray-600 dark:text-dark-text'>Which client would you like to create this for?</p>
                    ...
                    <List className='w-full max-h-[40vh] overflow-y-auto'>
                        {
                            clients?.map((client, index) => {
                                return <ListItem onClick={() => onSelect(client?.id)} className='border-b border-gray-500 relative h-24 hover:bg-primary cursor-pointer dark:hover:bg-dark-hover dark:text-dark-text'>
                                    <ListItemAvatar>
