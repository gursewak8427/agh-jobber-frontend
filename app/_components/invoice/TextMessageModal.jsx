    ...
    return (
        <CustomModal wide={true} show={Boolean(open)} onClose={onClose}>
            <div className="space-y-6">
                <ModalHeading onClose={onClose}>Send Invoice #{invoice.invoiceno} to {getClientName(client)} as text message</ModalHeading>
            </div>
                    ...
                    <div className="flex gap-4">
                        ...
                        <div className='w-1/2'>
                            <div className='rounded-xl rounded-bl-none bg-primary-dark p-4 text-sm dark:bg-dark-primary'>
                                ...
                                <div className="mt-4">View your invoice here https://client.prosbro.com/TfdR00c5tr9</div>
                            </div>
                            <p className="text-gray-500 italic">Your client can view the invoice in their client hub.</p>
                        </div>
                    </div>
                    <div className="flex gap-2 items-center justify-end">
                        <CustomButton onClick={onClose} title="Cancel"></CustomButton>
                        <CustomButton type={"submit"} loading={loadingObj.invoicemessage} variant={"primary"} title="Send"></CustomButton>
                    </div>
                </div>
            </form>
        </CustomModal>
